...
async def get_submenu_by_id(target_menu_id: UUID, target_submenu_id: UUID, submenu_service: Annotated[SubmenuService, Depends(submenu_service)]):
...
async def delete_submenu_by_id(target_menu_id: UUID, target_submenu_id: UUID, submenu_service: Annotated[SubmenuService, Depends(submenu_service)]):
