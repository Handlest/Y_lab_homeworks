...
@submenu_router.get('/{target_submenu_id}', response_model=FullSubmenuPydantic,
                    ...
                    responses={status.HTTP_404_NOT_FOUND: {'description': 'Submenu with given id was not found'}})
...
@submenu_router.post('', response_model=Submenu_Pydantic, summary='Create new submenu',
                     responses={status.HTTP_400_BAD_REQUEST: {'description': 'Submenu with given title already exists'},
